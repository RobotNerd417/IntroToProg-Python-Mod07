...
#   Reilly Thomer,11/24/2024,Script Edited
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    ChangeLog:
        Reilly Thomer,11/24/2024,Created Class
...
class Student(Person):
    ...
    def __init__(self,first_name: str ="", last_name: str = "",course_name: str = ""):
        ...
        self.course_name = course_name  # set the attribute using the property to provide validation
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        Reilly Thomer, 11/24/2024, Converted list of dictionaries to list of student objects
        ...
        try:
            ...
            list_student_data = json.load(file) # the load function returns a list of dictionary rows.
            for student in list_student_data: # Convert the list of dictionary rows into Student objects
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        Reilly Thomer,11/24/2024,Converted code to use student objects instead of dictionaries
        ...
        try:
            ...
            for student in student_data:  # Convert List of Student objects to list of dictionary rows.
                ...
                save_student_data.append(student_json)

            file = open(file_name, "w")
            json.dump(save_student_data, file)
            file.close()
            ...
            message = "Error: There was a problem with writing to the json file.\n"
